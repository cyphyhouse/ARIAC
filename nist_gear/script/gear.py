...
def main(sysargv=None):
	...
	'roslaunch',
        os.path.join('/home/ariac/ariac_generated_worlds/ariac_world2', 'gear.launch'),
        'world_path:=' + os.path.join('/home/ariac/ariac_generated_worlds/ariac_world2', 'ariac.world'),
        'gear_urdf_xacro:=' + os.path.join('/home/ariac/ariac_generated_worlds/ariac_world2', 'gear.urdf.xacro'),
        'gantry_urdf_xacro:=' + os.path.join('/home/ariac/ariac_generated_worlds/ariac_world2', 'gantry.urdf.xacro'),
        'kitting_urdf_xacro:=' + os.path.join('/home/ariac/ariac_generated_worlds/ariac_world2', 'kitting.urdf.xacro'),
    ]
    if args.log_to_file:
